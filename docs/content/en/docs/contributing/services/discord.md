...
- **Joined voice channel only**: ingest regular channel messages from members who are currently in the same voice channel as AIRI; DMs and mentions are ignored in this mode
